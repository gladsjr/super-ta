...
var ASM_CONSTS = {
  ...
  1502285: () => (typeof HTMLCanvasElement !== "undefined"),
  1502340: () => !!Module["preinitializedWebGPUDevice"],
  1502391: () => {
...
function assignWasmExports(wasmExports) {
  ...
  _interactive_segmenter_v2_create = Module["_interactive_segmenter_v2_create"] = wasmExports["Vd"];
  _interactive_segmenter_v2_set_image = Module["_interactive_segmenter_v2_set_image"] = wasmExports["Wd"];
  _interactive_segmenter_v2_segment = Module["_interactive_segmenter_v2_segment"] = wasmExports["Xd"];
  _interactive_segmenter_v2_close = Module["_interactive_segmenter_v2_close"] = wasmExports["Yd"];
  _wgpuDeviceAddRef = wasmExports["Zd"];
  _addBoundTextureAsImageToStream = Module["_addBoundTextureAsImageToStream"] = wasmExports["_d"];
  _attachImageListener = Module["_attachImageListener"] = wasmExports["$d"];
  _attachImageVectorListener = Module["_attachImageVectorListener"] = wasmExports["ae"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["be"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["ce"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["de"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["ee"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["fe"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["ge"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["he"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["ie"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["je"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["ke"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["le"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["me"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["ne"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["oe"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["pe"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["qe"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["re"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["se"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["te"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["ue"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["ve"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["we"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["xe"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["ye"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["ze"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["Ae"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["Be"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["Ce"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["De"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["Ee"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Fe"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Ge"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["He"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["Ie"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Je"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Ke"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Le"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Me"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Ne"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Oe"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Pe"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Qe"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Re"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Se"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Te"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Ue"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Ve"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["We"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["Xe"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Ye"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Ze"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["_e"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["$e"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["af"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["bf"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["cf"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["df"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["ef"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["ff"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["gf"];
  ___getTypeName = wasmExports["hf"];
  _emwgpuCreateBindGroup = wasmExports["jf"];
  _emwgpuCreateBindGroupLayout = wasmExports["kf"];
  _emwgpuCreateCommandBuffer = wasmExports["lf"];
  _emwgpuCreateCommandEncoder = wasmExports["mf"];
  _emwgpuCreateComputePassEncoder = wasmExports["nf"];
  _emwgpuCreateComputePipeline = wasmExports["of"];
  _emwgpuCreateExternalTexture = wasmExports["pf"];
  _emwgpuCreatePipelineLayout = wasmExports["qf"];
  _emwgpuCreateQuerySet = wasmExports["rf"];
  _emwgpuCreateRenderBundle = wasmExports["sf"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["tf"];
  _emwgpuCreateRenderPassEncoder = wasmExports["uf"];
  _emwgpuCreateRenderPipeline = wasmExports["vf"];
  _emwgpuCreateSampler = wasmExports["wf"];
  _emwgpuCreateSurface = wasmExports["xf"];
  _emwgpuCreateTexture = wasmExports["yf"];
  _emwgpuCreateTextureView = wasmExports["zf"];
  _emwgpuCreateAdapter = wasmExports["Af"];
  _emwgpuImportBuffer = wasmExports["Bf"];
  _emwgpuCreateDevice = wasmExports["Cf"];
  _emwgpuCreateQueue = wasmExports["Df"];
  _emwgpuCreateShaderModule = wasmExports["Ef"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Ff"];
  _emwgpuOnCreateRenderPipelineCompleted = wasmExports["Gf"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["Hf"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["If"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["Jf"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Kf"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Lf"];
  _processGl = Module["_processGl"] = wasmExports["Mf"];
  _process = Module["_process"] = wasmExports["Nf"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Of"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Pf"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["Qf"];
  _closeGraph = Module["_closeGraph"] = wasmExports["Rf"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["Sf"];
  _emscripten_builtin_memalign = wasmExports["Uf"];
  _memalign = wasmExports["Vf"];
  __emscripten_tempret_set = wasmExports["Wf"];
  __emscripten_stack_restore = wasmExports["Xf"];
  __emscripten_stack_alloc = wasmExports["Yf"];
  _emscripten_stack_get_current = wasmExports["Zf"];
  ...
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = wasmExports["Tf"].value;
}
