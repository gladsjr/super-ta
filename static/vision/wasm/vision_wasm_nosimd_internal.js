...
var ASM_CONSTS = {
  ...
  1501391: () => (typeof HTMLCanvasElement !== "undefined"),
  1501446: () => !!Module["preinitializedWebGPUDevice"],
  1501497: () => {
...
var _free, _malloc, _interactive_segmenter_v2_create, _interactive_segmenter_v2_set_image, _interactive_segmenter_v2_segment, _interactive_segmenter_v2_close, _wgpuDeviceAddRef, _addBoundTextureAsImageToStream, _attachImageListener, _attachImageVectorListener, _registerModelResourcesGraphService, _bindTextureToStream, _addBoundTextureToStream, _addDoubleToInputStream, _addFloatToInputStream, _addBoolToInputStream, _addIntToInputStream, _addUintToInputStream, _addStringToInputStream, _addRawDataSpanToInputStream, _allocateBoolVector, _allocateFloatVector, _allocateDoubleVector, _allocateIntVector, _allocateUintVector, _allocateStringVector, _addBoolVectorEntry, _addFloatVectorEntry, _addDoubleVectorEntry, _addIntVectorEntry, _addUintVectorEntry, _addStringVectorEntry, _addBoolVectorToInputStream, _addFloatVectorToInputStream, _addDoubleVectorToInputStream, _addIntVectorToInputStream, _addUintVectorToInputStream, _addStringVectorToInputStream, _addFlatHashMapToInputStream, _addProtoToInputStream, _addEmptyPacketToInputStream, _addBoolToInputSidePacket, _addDoubleToInputSidePacket, _addFloatToInputSidePacket, _addIntToInputSidePacket, _addUintToInputSidePacket, _addStringToInputSidePacket, _addRawDataSpanToInputSidePacket, _addProtoToInputSidePacket, _addBoolVectorToInputSidePacket, _addDoubleVectorToInputSidePacket, _addFloatVectorToInputSidePacket, _addIntVectorToInputSidePacket, _addUintVectorToInputSidePacket, _addStringVectorToInputSidePacket, _attachBoolListener, _attachBoolVectorListener, _attachDoubleListener, _attachDoubleVectorListener, _attachFloatListener, _attachFloatVectorListener, _attachIntListener, _attachIntVectorListener, _attachUintListener, _attachUintVectorListener, _attachStringListener, _attachStringVectorListener, _attachProtoListener, _attachProtoVectorListener, _getGraphConfig, ___getTypeName, _emwgpuCreateBindGroup, _emwgpuCreateBindGroupLayout, _emwgpuCreateCommandBuffer, _emwgpuCreateCommandEncoder, _emwgpuCreateComputePassEncoder, _emwgpuCreateComputePipeline, _emwgpuCreateExternalTexture, _emwgpuCreatePipelineLayout, _emwgpuCreateQuerySet, _emwgpuCreateRenderBundle, _emwgpuCreateRenderBundleEncoder, _emwgpuCreateRenderPassEncoder, _emwgpuCreateRenderPipeline, _emwgpuCreateSampler, _emwgpuCreateSurface, _emwgpuCreateTexture, _emwgpuCreateTextureView, _emwgpuCreateAdapter, _emwgpuImportBuffer, _emwgpuCreateDevice, _emwgpuCreateQueue, _emwgpuCreateShaderModule, _emwgpuOnCreateComputePipelineCompleted, _emwgpuOnCreateRenderPipelineCompleted, _clearSubgraphs, _pushBinarySubgraph, _pushTextSubgraph, _changeBinaryGraph, _changeTextGraph, _processGl, _process, _bindTextureToCanvas, _requestShaderRefreshOnGraphChange, _waitUntilIdle, _closeGraph, _setAutoRenderToScreen, _emscripten_builtin_memalign, _memalign, __emscripten_tempret_set, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, dynCall_ji, dynCall_jii, dynCall_iiiijij, dynCall_vij, dynCall_viiji, dynCall_viji, dynCall_iiiji, dynCall_jjj, dynCall_iiiijj, dynCall_viijj, dynCall_viiijjj, dynCall_viijii, dynCall_vijjj, dynCall_vj, dynCall_viij, dynCall_jiji, dynCall_iiiiij, dynCall_iiiiijj, dynCall_iiiiiijj, memory, _kVersionStampBuildChangelistStr, _kVersionStampCitcSnapshotStr, _kVersionStampCitcWorkspaceIdStr, _kVersionStampSourceUriStr, _kVersionStampBuildClientStr, _kVersionStampBuildClientMintStatusStr, _kVersionStampBuildCompilerStr, _kVersionStampBuildDateTimePstStr, _kVersionStampBuildDepotPathStr, _kVersionStampBuildIdStr, _kVersionStampBuildInfoStr, _kVersionStampBuildLabelStr, _kVersionStampBuildTargetStr, _kVersionStampBuildTimestampStr, _kVersionStampBuildToolStr, _kVersionStampG3BuildTargetStr, _kVersionStampVerifiableStr, _kVersionStampBuildFdoTypeStr, _kVersionStampBuildBaselineChangelistStr, _kVersionStampBuildLtoTypeStr, _kVersionStampBuildPropellerTypeStr, _kVersionStampBuildPghoTypeStr, _kVersionStampBuildUsernameStr, _kVersionStampBuildHostnameStr, _kVersionStampBuildDirectoryStr, _kVersionStampBuildChangelistInt, _kVersionStampCitcSnapshotInt, _kVersionStampBuildClientMintStatusInt, _kVersionStampBuildTimestampInt, _kVersionStampVerifiableInt, _kVersionStampBuildCoverageEnabledInt, _kVersionStampBuildBaselineChangelistInt, _kVersionStampPrecookedTimestampStr, _kVersionStampPrecookedClientInfoStr, __indirect_function_table, _kVersionStampBuildHasHardeningProtobuf, wasmMemory, wasmTable;

function assignWasmExports(wasmExports) {
  _free = Module["_free"] = wasmExports["Sd"];
  _malloc = Module["_malloc"] = wasmExports["Td"];
  _interactive_segmenter_v2_create = Module["_interactive_segmenter_v2_create"] = wasmExports["Ud"];
  _interactive_segmenter_v2_set_image = Module["_interactive_segmenter_v2_set_image"] = wasmExports["Vd"];
  _interactive_segmenter_v2_segment = Module["_interactive_segmenter_v2_segment"] = wasmExports["Wd"];
  _interactive_segmenter_v2_close = Module["_interactive_segmenter_v2_close"] = wasmExports["Xd"];
  _wgpuDeviceAddRef = wasmExports["Yd"];
  _addBoundTextureAsImageToStream = Module["_addBoundTextureAsImageToStream"] = wasmExports["Zd"];
  _attachImageListener = Module["_attachImageListener"] = wasmExports["_d"];
  _attachImageVectorListener = Module["_attachImageVectorListener"] = wasmExports["$d"];
  _registerModelResourcesGraphService = Module["_registerModelResourcesGraphService"] = wasmExports["ae"];
  _bindTextureToStream = Module["_bindTextureToStream"] = wasmExports["be"];
  _addBoundTextureToStream = Module["_addBoundTextureToStream"] = wasmExports["ce"];
  _addDoubleToInputStream = Module["_addDoubleToInputStream"] = wasmExports["de"];
  _addFloatToInputStream = Module["_addFloatToInputStream"] = wasmExports["ee"];
  _addBoolToInputStream = Module["_addBoolToInputStream"] = wasmExports["fe"];
  _addIntToInputStream = Module["_addIntToInputStream"] = wasmExports["ge"];
  _addUintToInputStream = Module["_addUintToInputStream"] = wasmExports["he"];
  _addStringToInputStream = Module["_addStringToInputStream"] = wasmExports["ie"];
  _addRawDataSpanToInputStream = Module["_addRawDataSpanToInputStream"] = wasmExports["je"];
  _allocateBoolVector = Module["_allocateBoolVector"] = wasmExports["ke"];
  _allocateFloatVector = Module["_allocateFloatVector"] = wasmExports["le"];
  _allocateDoubleVector = Module["_allocateDoubleVector"] = wasmExports["me"];
  _allocateIntVector = Module["_allocateIntVector"] = wasmExports["ne"];
  _allocateUintVector = Module["_allocateUintVector"] = wasmExports["oe"];
  _allocateStringVector = Module["_allocateStringVector"] = wasmExports["pe"];
  _addBoolVectorEntry = Module["_addBoolVectorEntry"] = wasmExports["qe"];
  _addFloatVectorEntry = Module["_addFloatVectorEntry"] = wasmExports["re"];
  _addDoubleVectorEntry = Module["_addDoubleVectorEntry"] = wasmExports["se"];
  _addIntVectorEntry = Module["_addIntVectorEntry"] = wasmExports["te"];
  _addUintVectorEntry = Module["_addUintVectorEntry"] = wasmExports["ue"];
  _addStringVectorEntry = Module["_addStringVectorEntry"] = wasmExports["ve"];
  _addBoolVectorToInputStream = Module["_addBoolVectorToInputStream"] = wasmExports["we"];
  _addFloatVectorToInputStream = Module["_addFloatVectorToInputStream"] = wasmExports["xe"];
  _addDoubleVectorToInputStream = Module["_addDoubleVectorToInputStream"] = wasmExports["ye"];
  _addIntVectorToInputStream = Module["_addIntVectorToInputStream"] = wasmExports["ze"];
  _addUintVectorToInputStream = Module["_addUintVectorToInputStream"] = wasmExports["Ae"];
  _addStringVectorToInputStream = Module["_addStringVectorToInputStream"] = wasmExports["Be"];
  _addFlatHashMapToInputStream = Module["_addFlatHashMapToInputStream"] = wasmExports["Ce"];
  _addProtoToInputStream = Module["_addProtoToInputStream"] = wasmExports["De"];
  _addEmptyPacketToInputStream = Module["_addEmptyPacketToInputStream"] = wasmExports["Ee"];
  _addBoolToInputSidePacket = Module["_addBoolToInputSidePacket"] = wasmExports["Fe"];
  _addDoubleToInputSidePacket = Module["_addDoubleToInputSidePacket"] = wasmExports["Ge"];
  _addFloatToInputSidePacket = Module["_addFloatToInputSidePacket"] = wasmExports["He"];
  _addIntToInputSidePacket = Module["_addIntToInputSidePacket"] = wasmExports["Ie"];
  _addUintToInputSidePacket = Module["_addUintToInputSidePacket"] = wasmExports["Je"];
  _addStringToInputSidePacket = Module["_addStringToInputSidePacket"] = wasmExports["Ke"];
  _addRawDataSpanToInputSidePacket = Module["_addRawDataSpanToInputSidePacket"] = wasmExports["Le"];
  _addProtoToInputSidePacket = Module["_addProtoToInputSidePacket"] = wasmExports["Me"];
  _addBoolVectorToInputSidePacket = Module["_addBoolVectorToInputSidePacket"] = wasmExports["Ne"];
  _addDoubleVectorToInputSidePacket = Module["_addDoubleVectorToInputSidePacket"] = wasmExports["Oe"];
  _addFloatVectorToInputSidePacket = Module["_addFloatVectorToInputSidePacket"] = wasmExports["Pe"];
  _addIntVectorToInputSidePacket = Module["_addIntVectorToInputSidePacket"] = wasmExports["Qe"];
  _addUintVectorToInputSidePacket = Module["_addUintVectorToInputSidePacket"] = wasmExports["Re"];
  _addStringVectorToInputSidePacket = Module["_addStringVectorToInputSidePacket"] = wasmExports["Se"];
  _attachBoolListener = Module["_attachBoolListener"] = wasmExports["Te"];
  _attachBoolVectorListener = Module["_attachBoolVectorListener"] = wasmExports["Ue"];
  _attachDoubleListener = Module["_attachDoubleListener"] = wasmExports["Ve"];
  _attachDoubleVectorListener = Module["_attachDoubleVectorListener"] = wasmExports["We"];
  _attachFloatListener = Module["_attachFloatListener"] = wasmExports["Xe"];
  _attachFloatVectorListener = Module["_attachFloatVectorListener"] = wasmExports["Ye"];
  _attachIntListener = Module["_attachIntListener"] = wasmExports["Ze"];
  _attachIntVectorListener = Module["_attachIntVectorListener"] = wasmExports["_e"];
  _attachUintListener = Module["_attachUintListener"] = wasmExports["$e"];
  _attachUintVectorListener = Module["_attachUintVectorListener"] = wasmExports["af"];
  _attachStringListener = Module["_attachStringListener"] = wasmExports["bf"];
  _attachStringVectorListener = Module["_attachStringVectorListener"] = wasmExports["cf"];
  _attachProtoListener = Module["_attachProtoListener"] = wasmExports["df"];
  _attachProtoVectorListener = Module["_attachProtoVectorListener"] = wasmExports["ef"];
  _getGraphConfig = Module["_getGraphConfig"] = wasmExports["ff"];
  ___getTypeName = wasmExports["gf"];
  _emwgpuCreateBindGroup = wasmExports["hf"];
  _emwgpuCreateBindGroupLayout = wasmExports["jf"];
  _emwgpuCreateCommandBuffer = wasmExports["kf"];
  _emwgpuCreateCommandEncoder = wasmExports["lf"];
  _emwgpuCreateComputePassEncoder = wasmExports["mf"];
  _emwgpuCreateComputePipeline = wasmExports["nf"];
  _emwgpuCreateExternalTexture = wasmExports["of"];
  _emwgpuCreatePipelineLayout = wasmExports["pf"];
  _emwgpuCreateQuerySet = wasmExports["qf"];
  _emwgpuCreateRenderBundle = wasmExports["rf"];
  _emwgpuCreateRenderBundleEncoder = wasmExports["sf"];
  _emwgpuCreateRenderPassEncoder = wasmExports["tf"];
  _emwgpuCreateRenderPipeline = wasmExports["uf"];
  _emwgpuCreateSampler = wasmExports["vf"];
  _emwgpuCreateSurface = wasmExports["wf"];
  _emwgpuCreateTexture = wasmExports["xf"];
  _emwgpuCreateTextureView = wasmExports["yf"];
  _emwgpuCreateAdapter = wasmExports["zf"];
  _emwgpuImportBuffer = wasmExports["Af"];
  _emwgpuCreateDevice = wasmExports["Bf"];
  _emwgpuCreateQueue = wasmExports["Cf"];
  _emwgpuCreateShaderModule = wasmExports["Df"];
  _emwgpuOnCreateComputePipelineCompleted = wasmExports["Ef"];
  _emwgpuOnCreateRenderPipelineCompleted = wasmExports["Ff"];
  _clearSubgraphs = Module["_clearSubgraphs"] = wasmExports["Gf"];
  _pushBinarySubgraph = Module["_pushBinarySubgraph"] = wasmExports["Hf"];
  _pushTextSubgraph = Module["_pushTextSubgraph"] = wasmExports["If"];
  _changeBinaryGraph = Module["_changeBinaryGraph"] = wasmExports["Jf"];
  _changeTextGraph = Module["_changeTextGraph"] = wasmExports["Kf"];
  _processGl = Module["_processGl"] = wasmExports["Lf"];
  _process = Module["_process"] = wasmExports["Mf"];
  _bindTextureToCanvas = Module["_bindTextureToCanvas"] = wasmExports["Nf"];
  _requestShaderRefreshOnGraphChange = Module["_requestShaderRefreshOnGraphChange"] = wasmExports["Of"];
  _waitUntilIdle = Module["_waitUntilIdle"] = wasmExports["Pf"];
  _closeGraph = Module["_closeGraph"] = wasmExports["Qf"];
  _setAutoRenderToScreen = Module["_setAutoRenderToScreen"] = wasmExports["Rf"];
  _emscripten_builtin_memalign = wasmExports["Tf"];
  _memalign = wasmExports["Uf"];
  __emscripten_tempret_set = wasmExports["Vf"];
  __emscripten_stack_restore = wasmExports["Wf"];
  __emscripten_stack_alloc = wasmExports["Xf"];
  _emscripten_stack_get_current = wasmExports["Yf"];
  ...
  _kVersionStampBuildHasHardeningProtobuf = Module["_kVersionStampBuildHasHardeningProtobuf"] = wasmExports["Sf"].value;
}
...
var wasmImports = {
  ...
  /** @export */ Ic: JsWrapErrorListenerInternal,
