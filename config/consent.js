...
<p><strong>Você está prestes a participar de uma entrevista conduzida por um sistema de inteligência artificial (SuperTA)</strong> sobre o trabalho que você submeteu.</p>

<h4>Como funciona</h4>
<ul>
  <li>A entrevista terá <strong>até 10 perguntas</strong>. Ao final, é automaticamente encerrada.</li>
  <li>O SuperTA produz apenas o transcript da entrevista. <strong>A nota e a avaliação final são responsabilidade exclusiva do(a) professor(a)</strong> — não há decisão automatizada de aprovação.</li>
</ul>
...
<h4>Retenção</h4>
<p>Ao final da entrevista, os recursos enviados à OpenAI (PDF, índice de busca e histórico de mensagens) são <strong>removidos automaticamente</strong>. O transcript em texto permanece no banco do SuperTA para o professor avaliar.</p>
...
<p>Esta entrevista é em modo áudio. Sua voz será transcrita automaticamente por um serviço de speech-to-text da OpenAI. <strong>O áudio bruto não é armazenado pelo SuperTA</strong>; apenas o texto transcrito é mantido.</p>
`.trim();
