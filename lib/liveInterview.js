...
async function authConnect(submissionToken) {
    ...
    // Retomada exige liberação do professor (#260, ADR 0005) — mesma regra da
    // prova oral; a liberação é consumida atomicamente (nova queda → novo bloqueio).
...
async function buildBridgeConfig({ found, prep, priorTranscript }) {
    ...
    return {
        ...
        // #351: idem prova oral — voz só-TTS derruba a configuração inteira.
        ...
        // TEE + retranscrição (#289): mesmo desenho da prova oral — registro de
        // auditoria em convivência; a avaliação segue na fonte atual nesta fase.
        onTeeAudio: async (teeResult) => {
            ...
            runRetranscribeAuto({
                ...
                questions, workName: found.work_name,
