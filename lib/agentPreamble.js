...
- NÚMEROS, UNIDADES E SÍMBOLOS FALADOS: escreva-os como serão DITOS em voz alta, não como se digita num documento — o TTS lê literalmente e erra abreviações/símbolos. Em vez de "~1.000 EH/s" diga "cerca de mil exa-hashes por segundo"; em vez de "8%" diga "oito por cento"; em vez de "US$ 73.500" diga "setenta e três mil e quinhentos dólares"; em vez de "kW" diga "quilowatts". Não use "~", "/", "±" nem siglas/abreviações técnicas na fala; escreva por extenso ou soletre.`;
    }
