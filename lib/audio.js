...
// Retorna { text, usage }. `usage` é opaco (Transcription.Tokens | Duration |
// undefined, conforme tipo da SDK) e fica em aberto para o caller ler via
// meteredStt(...) e calcular custo. O caller costuma só precisar de `text`.
