...
if (_effort != null && _effort !== "" && !["minimal", "low", "medium", "high"].includes(_effort)) {
    throw new Error(`config/policy.yaml models.principal_reasoning_effort inválido: "${_effort}" (use minimal|low|medium|high ou remova)`);
}
