...
import { mapBuilderAgent, planBuilderAgent } from "./agents.js";
import {
    loadSystemPrompt,
    TTS_MODEL,
...
// Cria Vector Store + indexa o file para RAG (file_search).
export async function createVectorStoreWithFile(fileId, sessionId) {
    try {
