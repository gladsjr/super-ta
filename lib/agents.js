...
// Assistente do professor no estúdio (JSON de propostas). Modelo de raciocínio
// PRINCIPAL: é uso de professor (baixa volumetria, na montagem do cenário) e
// exige entender ordem das etapas, formas, info privada — qualidade > custo aqui.
export const scenarioAssistantAgent = new ScenarioAssistantAgent(openai, PRINCIPAL_REASONING_MODEL);
