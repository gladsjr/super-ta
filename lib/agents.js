...
import { OralExamAspectsAgent } from "../agents/OralExamAspectsAgent.js";
...
// Prova oral: avalia comparando a transcrição do aluno ao gabarito (modelo forte).
export const oralExamEvaluatorAgent = new OralExamEvaluatorAgent(openai, PRINCIPAL_REASONING_MODEL);
// Prova oral: gera aspectos de cobertura por pergunta (tópicos, não respostas; modelo rápido).
export const oralExamAspectsAgent = new OralExamAspectsAgent(openai, FAST_MODEL);
