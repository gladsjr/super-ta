...
import { RubricCriterionCheckAgent } from "../agents/RubricCriterionCheckAgent.js";
...
// Prova oral: revisa se os critérios de pontuação do professor são adequados como
// prompt de nota (advisory, não bloqueia). Modelo rápido.
export const rubricCriterionCheckAgent = new RubricCriterionCheckAgent(openai, FAST_MODEL);
