...
//
// Fallback legado: banco sem as tabelas da camada institucional (dev antigo,
// antes do db:migrate) mantém o comportamento "logado = admin" — igual aos
// seeds, que também toleram schema ausente.
export async function requireAdmin(req, res, next) {
    ...
    try {
        ...
        if (/relation .*(memberships|roles).* does not exist/i.test(err.message)) return next();
