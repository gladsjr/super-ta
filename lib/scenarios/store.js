...
export async function createRun(scenarioId, submissionId = null) {
    ...
    return { id, scenario_id: scenarioId, submission_id: submissionId, mode: "mock", interaction_index: 0, transcript: [], memory: null, evaluation_json: null, grades_json: null, done: false, student_work: {}, devolutiva_json: null, evaluation_published_at: null, grade_published_at: null };
}
