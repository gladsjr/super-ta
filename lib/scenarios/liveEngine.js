...
export async function interactionStartLive(agent, { scenario, interaction, personasById, idx, total, runMemory = "", meterCtx = null, interactionMode = "text", vectorStoreId = null }) {
    ...
    const op = await agent.interactionOpener({ scenario, interaction, personasById, position, total, runMemory, interactionMode, meterCtx, vectorStoreId });
