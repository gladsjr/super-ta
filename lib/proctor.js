...
const PHONE_CONF = 0.45;   // recall p/ celular a distância/ângulo (era 0.60); PHONE_MIN_AREA ainda exclui relógio. [validar reanalisando: não pode virar falso-positivo em relógio]
...
export async function analyzeOralVideoParts(videoKeys) {
    ...
    const summary = {
        ...
        flags: {
            ...
            multiple_people: mergeFlag("multiple_people"),
            phone: mergeFlag("phone"),
        },
        analyzed_at: new Date().toISOString(),
        model: parts[0].model,
