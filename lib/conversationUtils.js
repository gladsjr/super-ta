...
export async function getConversationContext(conversationId, limit = 12) {
...
export async function logLastConvItem(conversationId, scope) {
...
export async function logFullConv(conversationId, scope, limit = 20) {
