...
// `q` opcional: o health check (#375) valida o token pelo SEU pool, com prazo
// de conexão e statement_timeout — a validação não pode ficar pendurada no
// pool do app quando é o banco que está sendo diagnosticado.
