...
export async function getObjectSize(key) {
    ...
    try {
        ...
        // Defesa em profundidade: se por qualquer motivo a tabela não estiver lá,
        // o vídeo continua sendo servido. Tamanho desconhecido custa só o seek —
        // a rota entrega o objeto inteiro em stream, nunca em memória. Perder o
        // seek é aceitável; perder o vídeo, não.
