...
flowchart LR
  ...
  GradeAgent --> OutGrades>"submissions.grades_json + grade_final;<br/>média ponderada em código; nota é uma SEÇÃO<br/>da devolutiva (include_grade), sem justificativas"]
